...
if (!$product) {
    ...
    $product_ref = '-';
    $product_price = 0;
    $main_image_url = 'assets/images/placeholder.png';
    $description_content = 'Aucune description disponible pour ce produit.';
} else {
    $product_name = $product['name'] ?? 'Sans nom';
    $product_ref = $product['name'] ?? '-';
    $product_price = $product['price'] ?? 0;
    $main_image_url = 'assets/images/' . ($product['image'] ?? 'placeholder.png');
